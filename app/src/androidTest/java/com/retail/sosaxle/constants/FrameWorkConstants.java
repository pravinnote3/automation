package com.retail.sosaxle.constants;
...
public class FrameWorkConstants {
    ...
    public static final String RESOURCES_PATH = "/src/androidTest/resources";
    ...
    public static final String CONFIG_JSON_PATH =
            PROJECT_PATH + RESOURCES_PATH + File.separator + "config.json";
